...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        $request->merge(['email' => ucfirst($capitalize_email)]);
        ...
        if ($this->attemptLogin($request)) {
            ...
            Alert::success('Sucesso', 'Seja bem-vindo ' . ucfirst(auth()->user()->name) . '!')->persistent(true, true);
    ...
    public function logout(Request $request)
    {
        ...
        Alert::success('Sucesso', 'Logout realizado com sucesso!')->persistent(true, true);
